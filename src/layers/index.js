...
const edif_construcciones_turisticas = TileWMS_base("Edificio de Contrucciones Turísticas", "edif_construcciones_turisticas");
const edif_depor_y_esparcimiento = TileWMS_base("Edificio de Deportes y Esparcimiento", "edif_depor_y_esparcimiento");
...
const infraestructura_aeroportuaria_punto = TileWMS_base("Infraestructura Aeroportuaria Punto", "infraestructura_aeroportuaria_punto");
